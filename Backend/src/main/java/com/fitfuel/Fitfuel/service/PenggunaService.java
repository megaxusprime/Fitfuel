...
public class PenggunaService implements UserDetailsService {
    ...
    public void tambahPengguna(RegisterRequest registerRequest) {
        ...
        Pengguna penggunaByEmail = penggunaRepository.findByEmail(registerRequest.getEmail());
        if (penggunaByEmail != null) {
    ...
    public boolean isValidUser(String email, String password) {
        ...
        return pengguna != null && pengguna.getPassword().equals(password); // Bandingkan password plaintext
    }
    ...
    public String getUsernameByEmail(String email) {
        ...
        throw new IllegalArgumentException("Pengguna dengan email ini tidak ditemukan");
    }
    ...
    public Pengguna loadUserInfoByUsername(String username) throws UsernameNotFoundException {
        Pengguna pengguna = penggunaRepository.findByUsername(username);
        if (pengguna == null) {
            throw new UsernameNotFoundException("User not found: " + username);
        }
